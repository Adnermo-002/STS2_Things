...
func _render() -> void:
	...
	creature.position = Vector2(960, 760)
	stage.add_child(creature)
	_add_texture_layer("res://images/backgrounds/living_rock_generated_fg.png", 3)
	await _wait_frames(12)
	await _save_frame("living-rock-layered-frame-000.png")
	await _wait_frames(57)
	await _save_frame("living-rock-layered-frame-069.png")
	await _wait_frames(36)
	await _save_frame("living-rock-layered-frame-105.png")
	await _wait_frames(500)
...
func _save_frame(name: String) -> void:
	...
	var output := "res://../build/verification/living-rock-cartoon-regeneration-20260817-v3/" + name
