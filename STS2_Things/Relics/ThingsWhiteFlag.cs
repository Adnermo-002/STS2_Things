...
public sealed class ThingsWhiteFlag : RelicModel
{
    public override RelicRarity Rarity => RelicRarity.Ancient;

    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        HoverTipFactory.FromCardWithCardHoverTips<ThingsSurrender>()
            .Concat(HoverTipFactory.FromCardWithCardHoverTips<Shame>());

    public override async Task AfterObtained()
    {
        CardModel surrender = Owner.RunState.CreateCard<ThingsSurrender>(Owner);
